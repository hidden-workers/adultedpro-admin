      ...
      <div className="flex flex-col gap-2">
        <div className="grid grid-cols-10 py-2">
          <div className="col-span-6">
            <p style={{ color: '#3C50E0' }} className="text-md">
              Titles
            </p>
          </div>
          <div className="col-span-2">
            <p style={{ color: '#3C50E0' }} className="text-center text-md">
              Candidates
            </p>
          </div>
          <div className="col-span-2">
            <p style={{ color: '#3C50E0' }} className="text-right text-md">
              Hired
            </p>
          </div>
        </div>
        <div className="relative z-1 grid grid-cols-10 py-2">
          ...
          <div className="col-span-6 pl-3.5">
            <p style={{ color: '#0d8b6c' }} className="text-sm">
