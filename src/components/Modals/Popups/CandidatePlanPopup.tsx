...
const CandidatePlanPopup: React.FC = () => {
  return (
    <div
      ...
      >
        <div className="absolute right-1/2 top-1/2 h-fit w-full max-w-142.5 -translate-y-1/2 translate-x-1/2 transform rounded-lg bg-white text-center dark:bg-boxdark">
          <div className="relative flex h-full w-full flex-col items-center justify-center px-8 py-12 md:py-15">
            ...
            <p className="mb-10">
              This feature will be released soon! Here you can review all of the
              candidates who have registered in the platform and filter for the
              right one to connect with.
            </p>
          </div>
        </div>
      </div>
...
export default CandidatePlanPopup;
