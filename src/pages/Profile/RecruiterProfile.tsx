...
const RecruiterProfile = () => {
  ...
  const onPersonalDetailSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    dispatch<any>(setUser(formData)).then(({ payload }) => {
      if (payload) {
        ...
        toast.success('Recruiter details updated.');
      }
    });
  };
  const onProfilePictureSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    dispatch<any>(setUser({ ...user, photoUrl: formData.photoUrl })).then(
      ({ payload }) => {
        if (payload) {
    ...
    <DefaultLayout>
      <div className="mx-auto max-w-270">
        <div className="mb-4">
          ...
          <p className="text-[17px]">Tell us about yourself</p>
        </div>
                ...
                <form onSubmit={onPersonalDetailSubmit}>
                  ...
                  <div className="flex justify-end gap-4.5">
                    <button
                      ...
                      type="submit"
                      disabled={loading.personalDetail || userIsLoading}
                    >
                ...
                <form onSubmit={onProfilePictureSubmit}>
                  <div className="mb-4 flex items-center gap-3">
                    <div className="h-14 w-14 rounded-full">
                      <img
                        src={formData.photoUrl || userThree}
                        alt="User"
                    ...
                    <div>
                      <span className="mb-1.5 text-black dark:text-white">
                        {profilePictureState.loading
                          ? `Uploading your picture - ${profilePictureState.progress.toFixed(1)} completed`
                          : 'Edit your photo'}
                      </span>
                    </div>
                  </div>
