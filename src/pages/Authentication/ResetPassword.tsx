...
const ResetPassword: React.FC = () => {
  ...
  const onSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!validate(email))
      return toast.error('Please enter correct email pattern');

    setIsLoading(true);

    // TODO: check whether user exists in db or not
      ...
      <div className="flex flex-wrap items-center">
        <div className="hidden w-full border-stroke dark:border-strokedark xl:block xl:w-1/2 xl:border-r-2">
          <div className="py-17.5 px-26 text-center">
            ...
            <p className="2xl:px-20">{/* TODO: place some text here */}</p>
            ...
            <form onSubmit={onSubmit}>
              ...
              <div>
                <input
                  ...
                  disabled={isLoading}
                  className="w-full cursor-pointer rounded-lg border border-primary bg-primary disabled:bg-primary/75 disabled:cursor-default p-4 text-white transition hover:bg-opacity-90"
                />
              </div>
            </form>
          </div>
